...
//------------------------------------------------------------------------------
vtkMRMLNodeNewMacro(vtkMRMLRTChannel26Cabin3BeamNode);
...
//----------------------------------------------------------------------------
void vtkMRMLRTChannel26Cabin3BeamNode::WriteXML(ostream& of, int nIndent)
{
...
//----------------------------------------------------------------------------
void vtkMRMLRTChannel26Cabin3BeamNode::ReadXMLAttributes(const char** atts)
{
...
void vtkMRMLRTChannel26Cabin3BeamNode::Copy(vtkMRMLNode *anode)
{
  ...
  vtkMRMLRTChannel26Cabin3BeamNode* node = vtkMRMLRTChannel26Cabin3BeamNode::SafeDownCast(anode);
  if (!node)
  {
    return;
  }
...
//----------------------------------------------------------------------------
void vtkMRMLRTChannel26Cabin3BeamNode::CopyContent(vtkMRMLNode *anode, bool deepCopy/*=true*/)
{
...
//----------------------------------------------------------------------------
void vtkMRMLRTChannel26Cabin3BeamNode::SetScene(vtkMRMLScene* scene)
{
  Superclass::SetScene(scene);
}

//----------------------------------------------------------------------------
void vtkMRMLRTChannel26Cabin3BeamNode::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
void vtkMRMLRTChannel26Cabin3BeamNode::SetIsocenterToMlcLayer1Distance(double distance)
{
...
//----------------------------------------------------------------------------
void vtkMRMLRTChannel26Cabin3BeamNode::SetIsocenterToMlcLayer2Distance(double distance)
{
